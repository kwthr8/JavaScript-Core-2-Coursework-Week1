...
for (let saturday in weeklyMealPlan) {
...
for (let (saturday, sunday) in numberOfItemsPerWeak) {
  console.log(numberOfItemsPerWeak[saturday, sunday]);
}